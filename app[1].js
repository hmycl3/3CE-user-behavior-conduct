const questions = [
  ...
  { id: "purchase_difficulties", section: "彩妆消费洞察", title: "您在购买彩妆时最大的困难是什么？", hint: "最多选择 3 项", type: "multi", max: 3, options: ["色号太多，不知道怎么选择", "无法找准个人风格定位", "容易被种草，但买回来闲置"] },
  { id: "recommendation_mismatch", section: "彩妆消费洞察", title: "您是否经历过“看到别人推荐某款彩妆很心动，但购买后发现不适合自己”？", type: "single", options: ["经常", "偶尔", "很少", "从没有"] },
  ...
  { id: "threece_churn_reasons", section: "关于 3CE", title: "如果您没有持续购买 3CE，原因是什么？", hint: "最多选择 3 项", type: "multi", max: 3, options: ["产品不错，但没有持续关注", "不知道新品适不适合自己", "感觉3CE只是阶段性流行", "其他品牌更有陪伴感", "价格因素"] },
  { id: "korean_content_interest", section: "韩系影视与风格", title: "您是否喜欢韩剧、韩系影视内容？", type: "single", options: ["经常观看", "偶尔观看", "不关注"] },
  { id: "kdrama_elements", section: "韩系影视与风格", title: "韩剧中的哪些元素会影响您的兴趣？", hint: "最多选择 3 项", type: "multi", max: 3, options: ["女主角性格", "妆容", "穿搭", "生活方式", "爱情/成长故事", "氛围感"] },
  { id: "character_projection", section: "韩系影视与风格", title: "当您看到影视中的角色时，您有没有想过“如果我是她，我会是什么样？”", type: "single", options: ["经常", "偶尔", "从没有"] },
  { id: "style_profile_inputs", section: "个人风格探索", title: "如果一个美妆品牌可以帮助您找到自己的风格，您希望它了解哪些信息？", hint: "可多选", type: "multi", options: ["我的性格", "我的脸型特点", "我的生活场景", "我的穿衣风格", "我的兴趣爱好", "我喜欢的影视角色"] },
  {
...
function render() {
  ...
  else renderOptionQuestion(question);
}
