const commonBeforeBranch = [
  ...
  { number: "Q6", id: "purchase_difficulties", section: "彩妆消费洞察", title: "您在购买彩妆时最大的困难是什么？", hint: "最多选择 3 项", type: "multi", max: 3, options: ["色号太多，不知道怎么选择", "无法找准个人风格定位", "容易被种草，但买回来闲置", "其他"], other: { id: "purchase_difficulties_other", label: "请填写您遇到的其他困难" } },
