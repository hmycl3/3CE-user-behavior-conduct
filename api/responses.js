...
const optionalTextKeys = [
  "purchase_difficulties_note",
  "recommendation_mismatch_note",
  "threece_churn_reasons_note",
  "kdrama_elements_note",
  "style_profile_inputs_note",
];
...
function validAnswers(value) {
  ...
  if (!optionalTextKeys.every((key) => validOptionalText(value[key]))) return false;
